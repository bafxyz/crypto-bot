    ...
    rules: [
      eslintLoader,
      {
        ...
        oneOf: [
          urlLoader,
          babelLoader(isDev),
          // Enabled SASS and Sass modules support for example header.module.scss.
          // Files that are not prefixed with "module" will be parsed normally.
          sassLoader(isDev),
          sassLoader(isDev, true),
